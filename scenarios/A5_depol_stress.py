...
def build_sweep_params():
    return [
        {"case_id": "a5_rho0.2", "rho": 0.2, "max_bounce": 2, "los_blocked": True},
        {"case_id": "a5_rho0.5", "rho": 0.5, "max_bounce": 2, "los_blocked": True},
    ]
...
def run_case(params):
    ...
    f = make_freq()
    dep = DepolConfig(enabled=True, rho=params["rho"], mode="inout", seed=11)
